...
const grants:Record<Role,readonly Permission[]>={
 ...
 firm_admin:["users.manage","client.read","client.write","case.read","case.write","document.read","document.write","transmission.prepare","refund_trace.prepare","integration.manage","billing.manage","audit.read"],
 ...
 support:["client.read","case.read","case.write"],student:[],client:["client.read","document.read","document.write"],auditor:["client.read","case.read","document.read","audit.read"]
};
