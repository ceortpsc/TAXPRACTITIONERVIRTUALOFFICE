...
docs=[('Platform-Operations-Manual.pdf',['docs/ARCHITECTURE.md','policies/EXECUTION-POLICY.md','runbooks/PRODUCTION-DEPLOYMENT.md']),('Refund-Casework-Manual.pdf',['docs/IRS-RECONCILIATION.md','runbooks/REFUND-CASEWORK.md']),('Andrea-Agent-Employee-Handbook.pdf',['resources/agents/ANDREA-SYSTEM-PROMPT.md','resources/agents/AGENT-OPERATIONS.md','resources/employees/EMPLOYEE-HANDBOOK.md']),('Ross-University-Academic-Catalog-2026-2027.pdf',['docs/ROSS-UNIVERSITY-ACADEMIC-CATALOG-2026-2027.md','docs/ACADEMIC-OPERATIONS-GATEWAY-BLUEPRINT.md','resources/curriculum/COURSEBOOK-AUTHORING-STANDARD.md']),('Ross-University-Governance-Academic-Registrar-Manual.pdf',['docs/university-governance/00-CONTROLLED-DOCUMENT-INDEX.md','docs/university-governance/01-CHARTER-BYLAWS-GOVERNANCE.md','docs/university-governance/02-INSTITUTIONAL-POLICIES.md','docs/university-governance/03-ACADEMIC-AFFAIRS-MANUAL.md','docs/university-governance/04-PROGRAM-DOCUMENT-STANDARD.md','docs/university-governance/05-REGISTRAR-SIS-TRANSCRIPT-POLICY.md','docs/university-governance/06-ACCREDITATION-EFFECTIVENESS.md','docs/university-governance/07-ACADEMIC-PROGRESS-ATTENDANCE-ACCOUNTABILITY.md','docs/university-governance/08-BOOKSTORE-EPUB-RESOURCE-POLICY.md','docs/university-governance/09-CURRICULUM-ASSESSMENT-AND-PROCTORING-STANDARD.md','docs/university-governance/FORMS-AND-TEMPLATES.md'])]
