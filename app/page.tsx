...
export default function Home() {
  return <main>
    <header><b>ROSS TAX PRO SOFTWARE CO.</b><nav><Link href="/refunds">Refunds</Link><Link href="/casework">Casework</Link><Link href="/master-file">Master File</Link><Link href="/settings">Settings</Link></nav></header>
    <section className="hero"><p className="eyebrow">TAX PRACTITIONER VIRTUAL OFFICE</p><h1>Refund intelligence.<br/><em>Compliance command.</em></h1><p className="lede">Authorized research, trace footprints, Master File reconciliation, hold-resolution casework, document governance, and auditable intervention planning.</p><div className="actions"><Link className="button primary" href="/refunds">Open refund command center</Link><Link className="button" href="/casework">Review interventions</Link></div></section>
