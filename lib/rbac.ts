export const roles=["owner","super_admin","compliance_officer","firm_admin","transmitter","tax_practitioner","case_manager","reviewer","support","student","client","auditor"] as const;
export type Role=typeof roles[number];
export const permissions=["tenant.manage","users.manage","roles.manage","client.read","client.write","case.read","case.write","transcript.import","transcript.review","document.read","document.write","transmission.prepare","transmission.approve","transmission.send","refund_trace.prepare","refund_trace.approve","integration.manage","billing.manage","audit.read","training.manage","support.ticket.read","support.ticket.write","support.chat.respond","support.escalate","support.knowledge.publish","support.incident.manage","identity.session.revoke"] as const;
...
const grants:Record<Role,readonly Permission[]>={
 ...
 support:["client.read","case.read","case.write","support.ticket.read","support.ticket.write","support.chat.respond","support.escalate"],student:[],client:["client.read","document.read","document.write"],auditor:["client.read","case.read","document.read","audit.read"]
};
