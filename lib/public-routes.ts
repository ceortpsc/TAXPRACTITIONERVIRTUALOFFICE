...
export const publicRoutes:readonly PublicRoute[]=[
 ...
 {path:"/universities/student-services",title:"University Student Services",description:"Admissions, enrollment, records, advising, social services, financial-aid readiness, billing and administration.",kind:"page",changeFrequency:"weekly",priority:.7,operational:false},
 {path:"/api/student-services/intake",title:"Student Services Intake Registry",description:"Fail-closed department, topic, field and readiness registry.",kind:"api",changeFrequency:"weekly",priority:.1,operational:true},
 {path:"/universities/directory",title:"University Directory",description:"Proposed human positions, department routing addresses and governed AI personas.",kind:"page",changeFrequency:"weekly",priority:.6,operational:false},
 {path:"/api/universities/directory",title:"University Directory API",description:"Non-secret university position, persona and student-communication template registry.",kind:"api",changeFrequency:"weekly",priority:.1,operational:true},
 ...
 {path:"/billing",title:"Billing and Product Operations",description:"Authenticated Stripe, product catalog, subscription, settlement and billing workspace.",kind:"page",changeFrequency:"weekly",priority:.7,operational:true},
 {path:"/crm",title:"CRM and Order Operations",description:"Authenticated CRM, opportunity, purchase-order, sales-order and settlement control plane.",kind:"page",changeFrequency:"weekly",priority:.6,operational:true},
 {path:"/api/billing/catalog",title:"Billing Catalog API",description:"Public non-secret controlled product and service catalog.",kind:"api",changeFrequency:"weekly",priority:.1,operational:true},
 {path:"/api/billing/readiness",title:"Billing Readiness API",description:"Role-gated Stripe and CRM billing activation status.",kind:"api",changeFrequency:"daily",priority:.1,operational:true},
 {path:"/api/crm/readiness",title:"CRM Order Readiness API",description:"Role-gated CRM, purchase-order, sales-order and settlement persistence status.",kind:"api",changeFrequency:"daily",priority:.1,operational:true},
