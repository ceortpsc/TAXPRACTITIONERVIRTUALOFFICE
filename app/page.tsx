...
export default function Home() {
  return <main>
    <header><b>ROSS TAX PRO SOFTWARE CO.</b><nav><Link href="/platforms">Platforms</Link><Link href="/solutions">Solutions</Link><Link href="/universities">Universities</Link><Link href="/training">Training</Link><Link href="/support">Support</Link><Link href="/sign-in">Sign In</Link></nav></header>
